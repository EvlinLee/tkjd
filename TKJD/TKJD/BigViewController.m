...
#import "itemCell.h"
#import "ShopModel.h"
@interface BigViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
-(void)requestData{
    ...
    [MHNetworkManager getRequstWithURL:API_URL params:@{@"a":@"agentslist",@"page":@(page),@"timestamp":time,@"nonce":[NSString md5To32bit:once],@"sign":sign,@"order":order,@"per":@"20",@"type":@"3"} successBlock:^(id returnData, int code, NSString *msg) {
